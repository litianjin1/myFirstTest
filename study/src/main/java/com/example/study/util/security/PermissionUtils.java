...
import com.example.study.util.MessageUtils1;
import com.example.study.util.constant.PermissionConstants;
...
public class PermissionUtils
{
    ...
    public static String getMsg(String permissionsStr)
    {
        ...
        {
            msg = MessageUtils1.message(VIEW_PERMISSION, permission);
        }
        return msg;
    }
}
